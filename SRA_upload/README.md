...
For the sample name, provide a short name that describes the sample, such as `Victora_OAS_MAP_barcodes`.
Also provide the rest of the information:

  - Organism: Severe acute respiratory syndrome coronavirus 2

  - strain: Wuhan-Hu-1 or Omicron BA.1
...
Finally, add a sample title, such as "Illumina barcode sequencing from mutational antigenic profiling of plasmas against the yeast-displayed SARS-CoV-2 Wuhan-Hu-1 and BA.1 RBD"
...
Also add a value for the *ftp_subfolder* that is meaningful for this particular submission, such as *Victora_OAS_MAP_barcodes*.
